...
export default function HelpPage() {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      setLoading(true)
      let query = supabase.from('posts').select('*').eq('type', 'help')
  ...
  return (
    <section className="max-w-5xl mx-auto pastel-card p-6">
      <h1 className="text-2xl font-semibold text-slate-800 mb-4">💞 Yardımlaşma</h1>

      <PostFilters categoryType="help" onFilterChange={setFilters} />
